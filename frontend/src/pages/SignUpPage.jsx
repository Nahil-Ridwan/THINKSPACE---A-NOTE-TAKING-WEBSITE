  ...
  return (
    <div className="flex flex-col min-h-screen justify-center">
      <div className="flex flex-col w-full max-w-md space-y-6 justify-center items-center mx-auto my-auto px-4">
        ...
        {/* Login Form */}
        <div className="bg-black/20 backdrop-blur-md shadow-lg border border-white/10 rounded-xl w-full p-8 mt-11">
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <h1 className="text-4xl font-bold mb-6 text-primary">REGISTER</h1>
